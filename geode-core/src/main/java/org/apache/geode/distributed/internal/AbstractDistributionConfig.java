...
public abstract class AbstractDistributionConfig extends AbstractConfig
  ...
  static {
    ...
    m.put(SSL_ENABLED_ENDPOINT_IDENTIFICATION,
        "If true, the endpoint identification/verification will be handled during SSL/TLS handshaking if ssl enabled using \"ssl-enabled-components\"");
