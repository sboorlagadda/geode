...
public class DataSourceManagerUnitTest {
  ...
  public void setup() throws Exception {
    ...
    connectionConfig = new ConnectorService.Connection("dataSource1", "url", null, null, (String[]) null);
    connectionConfig2 = new ConnectorService.Connection("dataSource2", "url", null, null, (String[]) null);
