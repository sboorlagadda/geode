...
public class CertStores {
  ...
  public CertStores(boolean client, String hostName) throws Exception {
    this(client, hostName, new TestSSLUtils.CertificateBuilder());
  }
  ...
  private CertStores(boolean client, String commonName, TestSSLUtils.CertificateBuilder certBuilder)
      throws Exception {
    String alias = client ? "client" : "server";
    sslConfig = TestSSLUtils.createSslConfig(client, alias, commonName, certBuilder);
  }
