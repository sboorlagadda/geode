...
pushd ${GEODE_BUILD}
  ...
  ./gradlew --no-daemon -x javadoc -x spotlessCheck :geode-core:integrationTest --tests org.apache.geode.distributed.ServerLauncherRemoteWithCustomLoggingIntegrationTest
